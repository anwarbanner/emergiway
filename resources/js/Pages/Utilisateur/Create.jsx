...
export default function UtilisateurCreate({ auth = { user: null } }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('utilisateur.saveutilisateur'), {
            onSuccess: () => reset(),
        });
    };
                    ...
                    >
                        <div className="p-6">
                            ...
                            <form onSubmit={handleSubmit} className="mt-6 space-y-6">
                                ...
                                >
                                    <InputLabel htmlFor="password" value="Mot de passe" className="text-emerald-700" />
                                    <TextInput
                                        id="password"
                                        name="password"
                                        type="password"
                                ...
                                >
                                    <InputLabel htmlFor="password_confirmation" value="Confirmer le mot de passe" className="text-emerald-700" />
                                    <TextInput
